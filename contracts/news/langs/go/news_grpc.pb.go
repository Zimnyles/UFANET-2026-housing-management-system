...
type NewsServiceClient interface {
	...
	GetNewsItem(ctx context.Context, in *GetNewsItemRequest, opts ...grpc.CallOption) (*NewsResponse, error)
}
...
func (c *newsServiceClient) GetNewsItem(ctx context.Context, in *GetNewsItemRequest, opts ...grpc.CallOption) (*NewsResponse, error) {
	out := new(NewsResponse)
	err := c.cc.Invoke(ctx, "/news.NewsService/GetNewsItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NewsServiceServer interface {
	...
	GetNewsItem(context.Context, *GetNewsItemRequest) (*NewsResponse, error)
}
...
func (UnimplementedNewsServiceServer) GetNewsItem(context.Context, *GetNewsItemRequest) (*NewsResponse, error) {
...
func _NewsService_GetNewsItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNewsItemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NewsServiceServer).GetNewsItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/news.NewsService/GetNewsItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsServiceServer).GetNewsItem(ctx, req.(*GetNewsItemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NewsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NewsService_GetNewsItem_Handler,
		},
	},
