...
type Env struct {
	ServiceName string `envconfig:"APP_NAME" default:"requests-service"`

	Host string `envconfig:"APP_HOST" default:"0.0.0.0"`
	Port int    `envconfig:"APP_PORT" default:"50054"`
	...
	PostgresDB       string `envconfig:"POSTGRES_DB"       default:"requests"`
